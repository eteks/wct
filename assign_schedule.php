									...
									<div class="assign_clone_content_edit clone_schedule_update">
									    ...
									    <div class="form-group col-md-12">
									    	<div class="col-md-12">
									      	...
									      	<div class="col-md-12">
									      		<input type="text" class="form-control bib_popup athlete_bib popup_bib fl bib_update"  placeholder="BIB NO" name="athlete_bib1" data-validation-error-msg="Please Enter the BIBO NO" data-validation="number">
											</div>
