		...
		<div class="col-xs-12 col-md-11">
			...
			<div class="col-xs-12 col-md-7 align_margin">
				<form id="result_form" name="result_form">
				    ...
				    <div class="form-group">
				      	<input type="text" class="form-control name_align fl result_athletemobile" id="result_athletemobile" placeholder="Mobile no" name="result_athletemobile" data-validation-error-msg="Please Enter the value that must contain 10 numbers" data-validation="length" data-validation-length="max10">
					...
					<div class="col-md-9 schedule_btn">					
						...
						<input onclick="document.getElementById('result_form').reset();return false" type="submit" class="btn btn-primary align_right clear" value="Clear">
					</div>			
				</form>
			</div>			
			<div class="container">           
